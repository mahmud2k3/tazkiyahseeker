...
public class SWVContext {
    ...
    public static String ASWV_ONESIGNAL_ID;
    ...
    public static void loadConfig(Context context) {
        ...
        ASWV_ONESIGNAL_ID = config.getString("onesignal.id", "").trim();
    ...
    public static class App extends Application {
        ...
        public void onCreate() {
            ...
            if (SWVContext.isOneSignalEnabled()) {
                try {
                    OneSignal.initWithContext(this, SWVContext.ASWV_ONESIGNAL_ID);
                    Log.i(TAG, "OneSignal initialized.");
                } catch (Exception e) {
                    Log.e(TAG, "OneSignal init failed. Check onesignal.id in swv.properties", e);
                }
            } else {
                Log.w(TAG, "OneSignal disabled: onesignal.id is missing in swv.properties");
            }
        }
    }

    public static boolean isOneSignalEnabled() {
        return ASWV_ONESIGNAL_ID != null && !ASWV_ONESIGNAL_ID.isEmpty();
    }
